...
void ShowMenu()
{
    cout << "======== Menu LinkedList By Fitri ========" << endl
         << endl;
...
int main()
{
    ...
    do
    {
        ...
        {
        case 1:
            cout << "create your new list : ";
            cin >> data;
            CreateMyList(data);
            break;
        case 2:
            cout << "Add your first list : ";
            cin >> data;
            AddBeginning(data);
            break;
        case 3:
            cout << "Add your last list : ";
            cin >> data;
            AddLast(data);
            break;
        case 4:
            cout << "Add your Middle list : ";
            cin >> data;
            cout << endl;
            cout << "Data added after : ";
            cin >> position;
            AddMidd(data, position);
            break;
        case 5:
            cout << "Delete your first list : ";
            cin >> data;
            DellFirst(data);
            break;
        case 6:
        ...
        case 7:
            ...
            break;
        case 8:
            cout << "Find or Change your first list : ";
            cin >> data;
            ChangeFirst(data);
            break;
        case 9:
            cout << "Find or Change your Last list : ";
            cin >> data;
            ChangeLast(data);
            break;
        case 10:
